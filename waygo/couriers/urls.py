...
urlpatterns = [
    ...
    path("accept_order/<int:order_id>/",views.curier_accept_order , name="accept_order"),
    path("courier_profile/", views.courier_profile, name="courier_profile"),
    path("order/on-the-way/", views.courier_order_on_the_way, name="order_on_the_way"),
    path("order/arrived/", views.courier_order_arrived, name="order_arrived"),
    path("order/complete/", views.courier_order_complete, name="order_completed"),
